...
* Implement Spotdl to have an option to download a track if it is missing from the subsonic database. Take a look at [spotdl]https://github.com/spotDL/spotify-downloader here
